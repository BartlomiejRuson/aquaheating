...
function MiniSlider() {
  return (
    <div className="w-4/5 grid grid-cols-2 md:flex md:items-center md:justify-around mx-auto max-w-4/5 py-10">
      ...
      <div className="miniSliderText text-sm md:text-base opacity-80 hover:opacity-100 text-center bg-white text-black  rounded-full flex items-center justify-center hover:bg-aquaBlue hover:text-white transition-all">
