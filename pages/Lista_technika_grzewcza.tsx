...
import Link from 'next/link';
    const grzewka = [
        ...
        },
        {
            ...
            mainUrl:`/GRZEWKA/H1091/Miarkownik1.jpg`,
            images:[`Miarkownik1.jpg`,`Miarkownik2.jpg`,`Miarkownik3.jpg`,`Miarkownik4.jpg`,`Miarkownik5.jpg`],
...
<div className='grid md:grid-cols-2 grid-cols-2 text-center p-5'>
        {grzewka.map(item=>(
<Link className="m-5" href={`/Grzewka/${item.Symbol}`} key={item.Symbol}>
